...
MODEL_RANKING = [
    "opencode-go/gpt-5-6-luna",   # top: razonamiento + precision alta
    "opencode-go/deepseek-v4-pro",
    "opencode-go/hy3",
]

CATEGORIAS_VALIDAS = ["Teatro", "Música", "Infantil", "Deportes", "Formación", "Otros"]
...
SYSTEM_PROMPT = (
    ...
    "- Incluye TODOS los eventos del mes, no solo los destacados. Omite servicios permanentes "
    "sin fecha concreta del mes (ej. telefons d'interes)."
)
...
# --------------------------------------------------------------------------
SEED_EVENTOS = [
    {"id": "evt-2026-09-06-mercat", "titulo": "Mercat de segona mà", "fecha_inicio": "2026-09-06", "fecha_fin": "2026-09-06", "hora_inicio": "10:00", "hora_fin": "14:00", "lugar": "Plaça de Pau Casals", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Mercat de segona mà al matí a la plaça de Pau Casals.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Plaça de Pau Casals, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-08-ludoteca", "titulo": "Portes obertes a la ludoteca La Baldufa", "fecha_inicio": "2026-09-08", "fecha_fin": "2026-09-08", "hora_inicio": "16:45", "hora_fin": "18:30", "lugar": "Carrer d'Anselm Clavé 9", "categoria": "Infantil", "precio_socios": None, "precio_general": None, "descripcion": "Jornada de portes obertes de la ludoteca La Baldufa. Activitat familiar: els infants han d'estar acompanyats per una persona adulta. També es podran fer les inscripcions per al nou curs.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Carrer d'Anselm Clavé 9, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-08-vitis", "titulo": "Les Empremtes del Temps, a la recerca dels vitis!", "fecha_inicio": "2026-09-08", "fecha_fin": "2026-09-08", "hora_inicio": "11:00", "hora_fin": None, "lugar": "Castell de Penyafort", "categoria": "Formación", "precio_socios": None, "precio_general": None, "descripcion": "Visita al Castell de Penyafort a les 11 h. Inscripció prèvia al 669 287 539.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Castell de Penyafort, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-10-diada", "titulo": "Acte institucional de la Diada Nacional de Catalunya", "fecha_inicio": "2026-09-10", "fecha_fin": "2026-09-10", "hora_inicio": "19:30", "hora_fin": "20:30", "lugar": "Plaça de l'Església", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Parlament institucional i actuació musical a càrrec del duet Xènia i Marc. Hissada de la bandera al campanar de l'església a càrrec de la parròquia i el Ball de Diables Spantus dels Monjos.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Plaça de l'Església, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-13-castell", "titulo": "Visita guiada al Castell de Penyafort", "fecha_inicio": "2026-09-13", "fecha_fin": "2026-09-13", "hora_inicio": "10:30", "hora_fin": "12:00", "lugar": "Castell de Penyafort", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Visita guiada al Castell de Penyafort a les 10.30 h i a les 12 h. Imprescindible inscripció prèvia al 669 287 539.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Castell de Penyafort, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-13-petjades", "titulo": "Les Petjades del Vesper", "fecha_inicio": "2026-09-13", "fecha_fin": "2026-09-13", "hora_inicio": "10:30", "hora_fin": "12:00", "lugar": "El Ciarga", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Visita combinada entre el Ciarga i les caves Nadal de Torrelavit. A les 10.30 h des del Ciarga; el desplaçament es fa en cotxes particulars. Inscripció prèvia al 669 287 539.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("El Ciarga, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-15-tangram", "titulo": "Berenar d'obertura del Tangram", "fecha_inicio": "2026-09-15", "fecha_fin": "2026-09-15", "hora_inicio": "16:30", "hora_fin": "17:30", "lugar": "Tangram (Ca l'Antic)", "categoria": "Infantil", "precio_socios": None, "precio_general": None, "descripcion": "Berenar d'obertura del Tangram. Cal inscripció prèvia per Whatsapp al 629 17 40 07 o presencial.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Tangram Ca l'Antic, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-16-caminada", "titulo": "Caminada de proximitat", "fecha_inicio": "2026-09-16", "fecha_fin": "2026-09-16", "hora_inicio": "09:30", "hora_fin": "12:00", "lugar": "Molí del Foix", "categoria": "Deportes", "precio_socios": None, "precio_general": None, "descripcion": "Passejada planera de connexió entre nuclis d'uns 5 km, a càrrec del Ball de Diables Spantus dels Monjos. Sortida a les 9.30 h del Molí del Foix. Inscripció prèvia a molidelfoix@smmonjos.cat o al 93 818 69 28.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Molí del Foix, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-16-botifarrada", "titulo": "Botifarrada popular", "fecha_inicio": "2026-09-16", "fecha_fin": "2026-09-16", "hora_inicio": "21:00", "hora_fin": "22:30", "lugar": "Plaça de Pau Casals", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Botifarrada popular a càrrec del Ball de Diables Spantus dels Monjos. Obsequi d'una peça de fruita i aigua als assistents.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Plaça de Pau Casals, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-16-concert", "titulo": "Concert: Kelly Isaiah", "fecha_inicio": "2026-09-16", "fecha_fin": "2026-09-16", "hora_inicio": "22:30", "hora_fin": "23:45", "lugar": "Plaça de Pau Casals", "categoria": "Música", "precio_socios": None, "precio_general": None, "descripcion": "Concert a càrrec de Kelly Isaiah a la plaça de Pau Casals. En acabar, sessió de DJ amb el Dj Àngel.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Plaça de Pau Casals, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-16-cantoral", "titulo": "Inici del Cant Coral (Coral Amics de Penyafel)", "fecha_inicio": "2026-09-16", "fecha_fin": "2026-09-16", "hora_inicio": "19:30", "hora_fin": "21:30", "lugar": "Casa de Cultura Mas Catarro", "categoria": "Formación", "precio_socios": None, "precio_general": None, "descripcion": "Inici dels assajos de la Coral Amics de Penyafel. Assajos dimecres de 19.30 h a 21.30 h. Inscripcions: 619 20 89 60 o coral.amics.penyafel@gmail.com.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Casa de Cultura Mas Catarro, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-19-dracs", "titulo": "Trobada de Dracs", "fecha_inicio": "2026-09-19", "fecha_fin": "2026-09-19", "hora_inicio": "18:00", "hora_fin": "23:30", "lugar": "Ajuntament / Plaça de l'Església", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "A les 18 h arribada i plantada dels dracs davant l'ajuntament; 19.30 h cercavila sense foc per l'Av. de Catalunya; 20 h cercavila de foc fins la plaça de l'Església; 21.30 h concurs d'enceses. Després, sopar popular (botifarra amb mongetes); venda de tiquets el 16 de setembre de 19 h a 21 h davant l'ajuntament.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Ajuntament Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-20-sabors", "titulo": "Sabors en temps de guerra · Memòria de la guerra aèria", "fecha_inicio": "2026-09-20", "fecha_fin": "2026-09-20", "hora_inicio": "09:00", "hora_fin": "13:00", "lugar": "El Ciarga", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Visita combinada entre Subirats i Santa Margarida i els Monjos (sortida 9 h des de Subirats) i entre el Ciarga i el Castell de Penyafort (sortida 11 h des del Ciarga). El desplaçament es fa en cotxes particulars. Inscripció prèvia a escapadasingular.com o al 669 28 75 39.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("El Ciarga, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-20-castell", "titulo": "Visita guiada al Castell de Penyafort", "fecha_inicio": "2026-09-20", "fecha_fin": "2026-09-20", "hora_inicio": "10:30", "hora_fin": "12:00", "lugar": "Castell de Penyafort", "categoria": "Otros", "precio_socios": None, "precio_general": None, "descripcion": "Visita guiada al Castell de Penyafort a les 10.30 h i a les 12 h. Imprescindible inscripció prèvia al 669 287 539.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Castell de Penyafort, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-20-teatre", "titulo": "Teatre: Genitalmente hablando 2", "fecha_inicio": "2026-09-20", "fecha_fin": "2026-09-20", "hora_inicio": "19:00", "hora_fin": "21:00", "lugar": "Societat La Margaridoia", "categoria": "Teatro", "precio_socios": "Gratuït", "precio_general": "8 €", "descripcion": "Obra 'Genitalmente hablando 2' a càrrec del grup Melodramatik's, a la societat La Margaridoia. Socis: gratuït. Públic: 8 €.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Societat La Margaridoia, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-20-cinema", "titulo": "Cinema: Tres Adioses", "fecha_inicio": "2026-09-20", "fecha_fin": "2026-09-20", "hora_inicio": "19:00", "hora_fin": "21:00", "lugar": "Societat La Margaridoia", "categoria": "Otros", "precio_socios": "3 €", "precio_general": "4,5 €", "descripcion": "Projecció de la pel·lícula 'Tres Adioses', d'Isabel Coixet, a la societat La Margaridoia. Socis: 3 €. Públic: 4,5 €.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Societat La Margaridoia, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-21-mapacamic", "titulo": "Dibuixa el teu mapa: visualitza el teu camí professional", "fecha_inicio": "2026-09-21", "fecha_fin": "2026-09-21", "hora_inicio": "09:15", "hora_fin": "12:15", "lugar": "Club de la Feina (Ca l'Antic)", "categoria": "Formación", "precio_socios": None, "precio_general": None, "descripcion": "Taller 'Dibuixa el teu mapa' per visualitzar el teu camí professional. Dilluns 21 de setembre de 9.15 h a 12.15 h. Inscripcions a la web de l'ajuntament.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Club de la Feina Ca l'Antic, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-22-matricules", "titulo": "Taller de matrícules per a bicis i patinets", "fecha_inicio": "2026-09-22", "fecha_fin": "2026-09-22", "hora_inicio": "17:30", "hora_fin": "19:00", "lugar": "Molí del Foix", "categoria": "Formación", "precio_socios": None, "precio_general": None, "descripcion": "Taller de matrícules per a bicicletes i patinets al Molí del Foix. Si véns amb la bicicleta o patinet t'emportaràs un obsequi. Setmana Europea de la Mobilitat.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Molí del Foix, Santa Margarida i els Monjos")},
    ...
    {"id": "evt-2026-09-25-aula", "titulo": "Aula Cultural: Eulàlia i Mercè, una lluita pel matronatge de Barcelona", "fecha_inicio": "2026-09-25", "fecha_fin": "2026-09-25", "hora_inicio": "17:00", "hora_fin": "18:30", "lugar": "Casal de la Gent Gran", "categoria": "Formación", "precio_socios": None, "precio_general": None, "descripcion": "Xerrada 'Eulàlia i Mercè, una lluita pel matronatge de Barcelona' a càrrec de Marc Jobani, a les 17 h al casal de la gent gran. Amb motiu del 45è aniversari del Drac dels Monjos.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Casal de la Gent Gran, Santa Margarida i els Monjos")},
    {"id": "evt-2026-09-25-concertball", "titulo": "Concert-ball: Gina & The Tonics", "fecha_inicio": "2026-09-25", "fecha_fin": "2026-09-25", "hora_inicio": "23:45", "hora_fin": "02:00", "lugar": "Plaça de l'Església", "categoria": "Música", "precio_socios": None, "precio_general": None, "descripcion": "Concert-ball a càrrec del grup Gina & The Tonics, a les 23.45 h a la plaça de l'església. Amb motiu del 45è aniversari del Drac dels Monjos.", "enlace_maps": "https://www.google.com/maps/search/?api=1&query=" + urllib.parse.quote("Plaça de l'Església, Santa Margarida i els Monjos")},
